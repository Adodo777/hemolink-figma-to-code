...
export default function ProcessSteps() {
  return (
    <section id="deroulement" className=" mt-12 sm:mt-16">
      <div className="hemo-container">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16 sm:mb-24">
            ...
            <p className="mt-4 text-blood-gray-400 text-base sm:text-lg leading-relaxed max-w-2xl">
                ...
                return (
                  <div key={step.number} className="relative flex flex-col md:flex-row items-start w-full group cursor-default">
                    ...
                    <div className="pl-12 md:pl-0 w-full md:w-[30%] lg:w-[35%] md:pr-12">
                      <h3 className={`font-semibold text-2xl sm:text-3xl tracking-tight transition-colors duration-300 ${isActive ? 'text-white' : 'text-blood-gray-500 group-hover:text-blood-gray-300'}`}>
                        {step.title}
                      </h3>
                    </div>
                    ...
                    <div className="pl-12 md:pl-0 w-full md:w-[70%] lg:w-[65%] md:pl-12 mt-2 md:mt-1">
                      <div className={`transition-opacity duration-300 ${isActive ? 'opacity-100' : 'opacity-60 group-hover:opacity-100'}`}>
                        <span className="font-semibold text-blood-gray-300 block mb-1.5 uppercase tracking-wide text-sm">{step.subtitle}</span>
                        <p className="text-sm sm:text-base text-blood-gray-400 leading-relaxed font-light">
                          {step.description}
                        </p>
                      </div>
                    </div>
